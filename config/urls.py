...
schema_view = get_schema_view(
    openapi.Info(
        title="JDH API",
        default_version='v0.993',
        description='John Dave Harris API',
        terms_of_service='https://www.google.com/policies/terms/',
        contact=openapi.Contact(email="ulugbekjoramurodov5@gmail.com"),
...
urlpatterns = [
    ...
    path('api/v1/', include('start.urls')),
